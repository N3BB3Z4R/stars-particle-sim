...
var particles = function (points) {
	var vertices = new Float32Array(points * 30).fill(0);
	var references = new Float32Array(points * 10);
...
for (var i = 0; i < textureArraySize; i += 8) {
	var radius = (1 - Math.pow(Math.random(), 3)) * 40;
